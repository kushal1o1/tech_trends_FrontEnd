...
const ManageSubscription = () => {
 ...
 <section className="py-12 md:py-20 px-4 sm:px-8 lg:px-12">
  <div className="rounded-xl shadow-2xl p-6 sm:p-8 md:p-12 text-white relative overflow-hidden bg-gradient-to-r from-purple-900 to-teal-900">
    ...
    <div className="absolute -right-16 -top-16 w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 bg-white/10 rounded-full blur-xl animate-float"></div>
    <div className="absolute -left-8 -bottom-8 w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 bg-purple-300/20 rounded-full blur-lg animate-float-reverse"></div>
    <div className="absolute right-1/4 bottom-0 w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-teal-400/20 rounded-full blur-md animate-float"></div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
      ...
      <div className="text-center md:text-left">
        ...
        <div className="flex justify-center md:justify-start">
          <img src={Logo} className="w-40 sm:w-48 md:w-56 lg:w-60 xl:w-64" alt="TechTrends" />
        </div>
      </div>

      {/* Right Column: Interactive Card */}
      <div className="mt-8 md:mt-0 w-full max-w-md mx-auto md:max-w-none">
              ...
              {step === 1 ? (
                ...
                <form onSubmit={handleUpdateCategories} className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    ...
                    <Button type="button" variant="danger" onClick={handleUnsubscribe} fullWidth>
                      Unsubscribe
                    </Button>
                  </div>
                </form>
